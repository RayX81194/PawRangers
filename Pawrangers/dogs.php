  ...
  <section class="section brand" aria-label="brand" style="background-image: url('./assets/images/dogbg.jpg')">
    <div class="container">
      ...
      <h2 class="text-center text-3xl">
        Adopted dogs bring immeasurable joy and companionship into our lives. Each one has a unique story and
        personality, enriching our homes with love and loyalty. By choosing adoption, we not only provide a loving home
        for a deserving dog but also contribute to ending pet overpopulation and homelessness.
      </h2>
    </div>
  </section>
...
$sql = "SELECT * FROM pet_info WHERE pet_category = 'Dog'";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      echo '
            ...
            <div class="button">
                <a href="tel:' . $pet_phone . '" class="boxbtn">Contact</a>
