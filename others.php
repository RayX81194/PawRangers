...
<div class="dropdown">
  ...
  <section class="section brand " aria-label="brand" style="background-image: url('./assets/images/dogbg.jpg')">
        <div class="container">
          ...
          Adopting animals such as rabbits, horses, birds, and many others adds unique charm to our lives. Each creature brings its own special qualities, enriching our homes with companionship and affection. By opening our hearts and homes to these animals, we provide them with the love and care they deserve while also promoting responsible pet ownership and animal welfare.
          </h2>
        </div>
      </section>
...
$sql = "SELECT * FROM pet_info WHERE pet_category = 'Others'";
